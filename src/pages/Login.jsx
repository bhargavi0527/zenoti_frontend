...
function Login() {
  const [username, setUsername] = useState('mythree.koyyana');
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <div className="w-12 h-12 bg-blue-400 rounded-full flex items-center justify-center mr-2">
                <span className="text-white text-2xl font-bold">O</span>
              </div>
              <div className="text-left">
                <h1 className="text-3xl font-bold text-gray-900">OLIVA</h1>
                <p className="text-sm text-gray-600">SKIN & HAIR CLINIC</p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-white border-t border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <span className="text-gray-600 text-sm">Follow us on</span>
          ...
          <div className="text-right">
            <div className="text-blue-500 font-bold text-lg">zenoti</div>
            <div className="text-xs text-gray-500">ASIA12a / 2025.6.25.423</div>
          </div>
        </div>

        {/* Advertisement Banner */}
        <div className="mt-6 bg-gradient-to-r from-blue-900 via-purple-800 to-pink-600 rounded-lg p-6 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-center justify-between">
            <div className="flex-1">
              <div className="flex items-center mb-2">
                <div className="text-2xl font-bold mr-2">Innergize</div>
                <div className="text-right">
