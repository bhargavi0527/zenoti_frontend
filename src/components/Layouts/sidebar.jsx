...
function Sidebar() {
  ...
  const getActiveItem = () => {
    if (location.pathname === '/guest' || location.pathname.startsWith('/guests/')) return 'guest';
  ...
  // Sync highlight and master accordion with current route
  useEffect(() => {
    setActiveItem(getActiveItem());
    setMasterOpen(location.pathname === '/master' || location.pathname.startsWith('/master/'));
  }, [location.pathname]);
